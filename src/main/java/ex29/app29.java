...
public class app29 {
    public static String doubleYourInvestment(String response){
        try
        {
            int i = Integer.valueOf(response);
            if(i > 0)
            {
                return String.format("It will take %d years to double your initial investment.", 72 / i);
            }
    ...
    public static void main(String[] args) {
        ...
        while(true)
        {
            ...
            System.out.println(doubleYourInvestment(response));
        }
    }
}